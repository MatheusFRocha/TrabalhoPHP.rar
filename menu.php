<div class="sidenav">
        ...
        <a href="form_materia.php">Administração de materias</a>
        <a href="form_matricula.php">Administração de matriculas</a>
        <a href="form_notaAluno.php">Administração de notas</a>
